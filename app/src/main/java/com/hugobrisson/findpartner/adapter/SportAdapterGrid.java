 ...
 */
public class SportAdapterGrid extends RecyclerView.Adapter<SportAdapterGrid.SportViewHolder> {
    ...
    public SportAdapterGrid(Context context, List<Sport> sports) {
        this.sports = sports;
    ...
    public SportViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = LayoutInflater.from(parent.getContext()).inflate(R.layout.sport_item_grid, parent, false);
